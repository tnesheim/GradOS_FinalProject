...
static _Bool                               m_is_link_loss_alerting;                           
static _Bool                               m_is_alert_led_blinking;                           
static _Bool                               m_is_adv_led_blinking;                             

static ble_bas_t                          m_bas;                                             
static ble_ias_c_t                        m_ias_c;                                           

static uint8_t                            m_advertising_mode;                                

static volatile _Bool                      m_is_high_alert_signalled;                         
...
{
    do { app_error_handler((nrf_error), 214, (uint8_t*) "..\\main.c"); } while (0);
}
...
void ADC_IRQHandler(void)
{
    if (((NRF_ADC_Type *) 0x40007000UL)->EVENTS_END != 0)
    {
        ...
        {
            do { app_error_handler((err_code), 250, (uint8_t*) "..\\main.c"); } while (0);
        }
    }
}
...
static void adc_start(void)
{
    ...
    do { const uint32_t LOCAL_ERR_CODE = (err_code); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 274, (uint8_t*) "..\\main.c"); } while (0); } } while (0);

    err_code = sd_nvic_SetPriority(ADC_IRQn, NRF_APP_PRIORITY_LOW);
    do { const uint32_t LOCAL_ERR_CODE = (err_code); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 277, (uint8_t*) "..\\main.c"); } while (0); } } while (0);

    err_code = sd_nvic_EnableIRQ(ADC_IRQn);
    do { const uint32_t LOCAL_ERR_CODE = (err_code); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 280, (uint8_t*) "..\\main.c"); } while (0); } } while (0);
...
static void adv_led_blink_start(void)
{
    ...
    {
        uint32_t             err_code;
        static volatile _Bool is_led_on;
        ...
        is_led_on             = 1;
        m_is_adv_led_blinking = 1;

        err_code = app_timer_start(m_adv_led_blink_timer_id, ((uint32_t)((((100) * (uint64_t)32768) + ((((0) + 1) * 1000) / 2)) / (((0) + 1) * 1000))), (void *)&is_led_on);
        do { const uint32_t LOCAL_ERR_CODE = (err_code); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 305, (uint8_t*) "..\\main.c"); } while (0); } } while (0);
    }
}
...
static void advertising_start(void)
{
    ...
    switch (m_advertising_mode)
    {
        ...
        case BLE_FAST_ADV_WHITELIST:
        {
            ...
            adv_params.interval = 0x0028;
            adv_params.timeout  = 30;
            break;
        }

        case BLE_FAST_ADV:
            advertising_init(((0x01) | (0x04)));
    ...
    do { const uint32_t LOCAL_ERR_CODE = (err_code); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 454, (uint8_t*) "..\\main.c"); } while (0); } } while (0);
...
static void mild_alert_timeout_handler(void * p_context)
{
    if (m_is_alert_led_blinking)
    {
        ...
        do { const _Bool LOCAL_BOOLEAN_VALUE = (p_context != 0); if (!LOCAL_BOOLEAN_VALUE) { do { app_error_handler((0), 491, (uint8_t*) "..\\main.c"); } while (0); } } while (0);

        nrf_gpio_pin_toggle(19);

        p_is_led_on = (_Bool *)p_context;
        ...
        *p_is_led_on = !(*p_is_led_on);
        ...
        if(*p_is_led_on)
        {
            ...
            next_timer_interval = ((uint32_t)((((100) * (uint64_t)32768) + ((((0) + 1) * 1000) / 2)) / (((0) + 1) * 1000)));
        }
        else
        {
            
            
            next_timer_interval = ((uint32_t)((((900) * (uint64_t)32768) + ((((0) + 1) * 1000) / 2)) / (((0) + 1) * 1000)));
        }
...
static void adv_led_blink_timeout_handler(void * p_context)
{
    if (m_is_adv_led_blinking)
    {
        ...
        do { const _Bool LOCAL_BOOLEAN_VALUE = (p_context != 0); if (!LOCAL_BOOLEAN_VALUE) { do { app_error_handler((0), 537, (uint8_t*) "..\\main.c"); } while (0); } } while (0);
...
static void timers_init(void)
{
    ...
    do { static uint32_t APP_TIMER_BUF[((((( (((6)) * 40) + ( 3 * (8 + (((6) + 1) + 1) * 24) ) )) - 1) / (sizeof(uint32_t))) + 1)]; uint32_t ERR_CODE = app_timer_init((0), (6), (6) + 1, APP_TIMER_BUF, (0) ? app_timer_evt_schedule : 0); do { const uint32_t LOCAL_ERR_CODE = (ERR_CODE); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 586, (uint8_t*) "..\\main.c"); } while (0); } } while (0); } while (0);
    ...
    do { const uint32_t LOCAL_ERR_CODE = (err_code); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 597, (uint8_t*) "..\\main.c"); } while (0); } } while (0);
...
static void gap_params_init(void)
{
    ...
    err_code = sd_ble_gap_appearance_set(576);
    do { const uint32_t LOCAL_ERR_CODE = (err_code); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 625, (uint8_t*) "..\\main.c"); } while (0); } } while (0);
    ...
    do { const uint32_t LOCAL_ERR_CODE = (err_code); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 638, (uint8_t*) "..\\main.c"); } while (0); } } while (0);
}
...
static void advertising_init(uint8_t adv_flags)
{
    ...
    do { const uint32_t LOCAL_ERR_CODE = (err_code); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 677, (uint8_t*) "..\\main.c"); } while (0); } } while (0);
}
...
static void tps_init(void)
{
    ...
    tps_init_obj.initial_tx_power_level = (-8);

    do {(&tps_init_obj . tps_attr_md . read_perm)->sm = 1; (&tps_init_obj . tps_attr_md . read_perm)->lv = 2;} while(0);
    do {(&tps_init_obj . tps_attr_md . write_perm)->sm = 0; (&tps_init_obj . tps_attr_md . write_perm)->lv = 0;} while(0);

    err_code = ble_tps_init(&m_tps, &tps_init_obj);
    do { const uint32_t LOCAL_ERR_CODE = (err_code); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 695, (uint8_t*) "..\\main.c"); } while (0); } } while (0);
}
...
static void lls_init(void)
{
    ...
    lls_init_obj.initial_alert_level = 0x00;

    do {(&lls_init_obj . lls_attr_md . read_perm)->sm = 1; (&lls_init_obj . lls_attr_md . read_perm)->lv = 2;} while(0);
    do {(&lls_init_obj . lls_attr_md . write_perm)->sm = 1; (&lls_init_obj . lls_attr_md . write_perm)->lv = 2;} while(0);

    err_code = ble_lls_init(&m_lls, &lls_init_obj);
    do { const uint32_t LOCAL_ERR_CODE = (err_code); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 732, (uint8_t*) "..\\main.c"); } while (0); } } while (0);

    m_is_link_loss_alerting = 0;
}
...
static void bas_init(void)
{
    ...
    bas_init_obj.support_notification = 1;
    bas_init_obj.p_report_ref         = 0;
    bas_init_obj.initial_batt_level   = 100;

    do {(&bas_init_obj . battery_level_char_attr_md . cccd_write_perm)->sm = 1; (&bas_init_obj . battery_level_char_attr_md . cccd_write_perm)->lv = 1;} while(0);
    do {(&bas_init_obj . battery_level_char_attr_md . read_perm)->sm = 1; (&bas_init_obj . battery_level_char_attr_md . read_perm)->lv = 1;} while(0);
    do {(&bas_init_obj . battery_level_char_attr_md . write_perm)->sm = 0; (&bas_init_obj . battery_level_char_attr_md . write_perm)->lv = 0;} while(0);

    do {(&bas_init_obj . battery_level_report_read_perm)->sm = 1; (&bas_init_obj . battery_level_report_read_perm)->lv = 1;} while(0);

    err_code = ble_bas_init(&m_bas, &bas_init_obj);
    do { const uint32_t LOCAL_ERR_CODE = (err_code); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 759, (uint8_t*) "..\\main.c"); } while (0); } } while (0);
}
...
static void ias_client_init(void)
{
    ...
    do { const uint32_t LOCAL_ERR_CODE = (err_code); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 780, (uint8_t*) "..\\main.c"); } while (0); } } while (0);
}
...
{
    do { app_error_handler((nrf_error), 802, (uint8_t*) "..\\main.c"); } while (0);
}
...
static void conn_params_init(void)
{
    ...
    do { const uint32_t LOCAL_ERR_CODE = (err_code); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 825, (uint8_t*) "..\\main.c"); } while (0); } } while (0);
}
...
static void on_ias_c_evt(ble_ias_c_t * p_ias_c, ble_ias_c_evt_t * p_evt)
{
    ...
    switch (p_evt->evt_type)
    {
        ...
        case BLE_IAS_C_EVT_DISCONN_COMPLETE:
            ...
            do { const uint32_t LOCAL_ERR_CODE = (err_code); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 930, (uint8_t*) "..\\main.c"); } while (0); } } while (0);
            break;
...
static void on_bas_evt(ble_bas_t * p_bas, ble_bas_evt_t *p_evt)
{
    ...
    switch (p_evt->evt_type)
    {
        case BLE_BAS_EVT_NOTIFICATION_ENABLED:
            ...
            err_code = app_timer_start(m_battery_timer_id, ((uint32_t)((((120000) * (uint64_t)32768) + ((((0) + 1) * 1000) / 2)) / (((0) + 1) * 1000))), 0);
            do { const uint32_t LOCAL_ERR_CODE = (err_code); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 956, (uint8_t*) "..\\main.c"); } while (0); } } while (0);
            break;

        case BLE_BAS_EVT_NOTIFICATION_DISABLED:
            err_code = app_timer_stop(m_battery_timer_id);
            do { const uint32_t LOCAL_ERR_CODE = (err_code); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 961, (uint8_t*) "..\\main.c"); } while (0); } } while (0);
            break;
...
static void on_ble_evt(ble_evt_t * p_ble_evt)
{
    ...
    switch (p_ble_evt->header.evt_id)
    {
        case BLE_GAP_EVT_CONNECTED:
            ...
            do { const uint32_t LOCAL_ERR_CODE = (err_code); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 995, (uint8_t*) "..\\main.c"); } while (0); } } while (0);
            break;
        ...
        case BLE_GAP_EVT_TIMEOUT:
            ...
            { 
                if (m_advertising_mode == BLE_SLEEP)
                {
                    ...
                    do { const uint32_t LOCAL_ERR_CODE = (err_code); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 1030, (uint8_t*) "..\\main.c"); } while (0); } } while (0);
                }
                else
                {
                    advertising_start();
        ...
        case BLE_GATTS_EVT_TIMEOUT:
            ...
            err_code = sd_ble_gap_disconnect(m_conn_handle, 
                                             0x13);
            do { const uint32_t LOCAL_ERR_CODE = (err_code); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 1044, (uint8_t*) "..\\main.c"); } while (0); } } while (0);
            break;
...
static void ble_stack_init(void)
{
    ...
    do { const uint32_t LOCAL_ERR_CODE = (err_code); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 1126, (uint8_t*) "..\\main.c"); } while (0); } } while (0);

    
    err_code = softdevice_ble_evt_handler_set(ble_evt_dispatch);
    do { const uint32_t LOCAL_ERR_CODE = (err_code); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 1130, (uint8_t*) "..\\main.c"); } while (0); } } while (0);

    
    err_code = softdevice_sys_evt_handler_set(sys_evt_dispatch);
    do { const uint32_t LOCAL_ERR_CODE = (err_code); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 1134, (uint8_t*) "..\\main.c"); } while (0); } } while (0);
}
...
static uint32_t device_manager_evt_handler(dm_handle_t const    * p_handle,
                                           ...
                                           api_result_t           event_result)
{
    do { const uint32_t LOCAL_ERR_CODE = (event_result); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 1146, (uint8_t*) "..\\main.c"); } while (0); } } while (0);
    return ((0x0) + 0);
}
...
static void device_manager_init(void)
{
    ...
    do { const uint32_t LOCAL_ERR_CODE = (err_code); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 1161, (uint8_t*) "..\\main.c"); } while (0); } } while (0);

    
    init_data.clear_persistent_data = (nrf_gpio_pin_read(17) == 0);

    err_code = dm_init(&init_data);
    do { const uint32_t LOCAL_ERR_CODE = (err_code); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 1167, (uint8_t*) "..\\main.c"); } while (0); } } while (0);
    ...
    do { const uint32_t LOCAL_ERR_CODE = (err_code); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 1182, (uint8_t*) "..\\main.c"); } while (0); } } while (0);
}
    ...
    if (button_action == 1)
    {
        switch (pin_no)
        {
            case 16:
                ...
                {
                    err_code = ble_ias_c_send_alert_level(&m_ias_c, 0x02);
                }
                else
                {
                    err_code = ble_ias_c_send_alert_level(&m_ias_c, 0x00);
                }
                ...
                {
                    do { app_error_handler((err_code), 1220, (uint8_t*) "..\\main.c"); } while (0);
                }
                break;
            ...
            default:
                do { app_error_handler((pin_no), 1229, (uint8_t*) "..\\main.c"); } while (0);
                break;
        }
    }    
}
...
{
    do { static uint32_t app_gpiote_buf[((((((1) * 20)) - 1) / (sizeof(uint32_t))) + 1)]; uint32_t ERR_CODE = app_gpiote_init((1), app_gpiote_buf); do { const uint32_t LOCAL_ERR_CODE = (ERR_CODE); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 1240, (uint8_t*) "..\\main.c"); } while (0); } } while (0); } while (0);
}
...
static void buttons_init(void)
{
    ...
    do { uint32_t ERR_CODE = app_button_init((buttons), (sizeof(buttons) / sizeof(buttons[0])), (((uint32_t)((((50) * (uint64_t)32768) + ((((0) + 1) * 1000) / 2)) / (((0) + 1) * 1000)))), (0) ? app_button_evt_schedule : 0); do { const uint32_t LOCAL_ERR_CODE = (ERR_CODE); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 1254, (uint8_t*) "..\\main.c"); } while (0); } } while (0); } while (0);
}
...
static void power_manage(void)
{
    ...
    do { const uint32_t LOCAL_ERR_CODE = (err_code); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 1263, (uint8_t*) "..\\main.c"); } while (0); } } while (0);
}
